...
document.addEventListener('DOMContentLoaded', () => {
  ...
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"])(calcForm);
  Object(_modules_showMoreStyles__WEBPACK_IMPORTED_MODULE_3__["default"])('.button-styles', '#styles .row');
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_4__["default"])('#size', '#material', '#options', '.promocode', '.calc-price', calcForm);
  ...
  Object(_modules_burger__WEBPACK_IMPORTED_MODULE_8__["default"])('.burger', '.burger-menu');
...
__webpack_require__.r(__webpack_exports__);
function drop() {
  const fileUnputs = document.querySelectorAll('[name = "upload"]');
  ['dragenter', 'dragleave', 'dragover', 'drop'].forEach(eventName => {
    fileUnputs.forEach(input => {
  ...
  function highlight(item) {
    ...
    item.closest('.file_upload').style.backgroundColor = 'grey';
  }
...
function forms(state) {
  ...
  form.forEach(item => {
    item.addEventListener('submit', e => {
      ...
      let api;
      item.closest('.popup-design') || item.classList.contains('calc_form') ? api = path.designer : api = path.qustion;
